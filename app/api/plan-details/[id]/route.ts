...
//     const updatedPlan = await prisma.plan_details.update({
//       where: { id:BigInt(id) },
//       data: {
//         plan:name,
//         frequency: BigInt(monthly_limit),
//         date: new Date(),
//       },
//     });
...
//     const plan = await prisma.plan_details.findFirst({
//       where: { userId },
//       include: {
//         user: true,
//       },
...
//       frequency: plan.frequency?.toString() ?? null,
//       user: {
//         ...plan.user,
//         id: plan.user.id.toString(),
//       },
//     };
