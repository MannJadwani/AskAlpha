...
export default function SignUp() {
  ...
  // If already authenticated, redirect to recommendation page
  useEffect(() => {
    let cancelled = false;
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-xs">
                <label htmlFor="terms" className="text-zinc-400">
                  I agree to the{' '}
                  <Link href="/terms" className="font-medium text-zinc-300 hover:text-white transition-colors">
                    Terms
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="font-medium text-zinc-300 hover:text-white transition-colors">
                    Privacy Policy
                  </Link>
                </label>
              </div>
